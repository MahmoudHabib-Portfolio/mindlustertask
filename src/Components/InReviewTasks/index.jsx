    ...
    <div ref={setNodeRef} className={Styles.todoCont}>
      ...
      <div>
        ...
        <div>
         ...
         icon={<GoDotFill style={{color:"#8c46be", fontSize:"1.6em"}}/>}
         label={<span className={Styles.todo}>In Review</span>}
         />
        </div>
        {/* Tasks Count */}
      ...
      {/* Task Body */}
      {revTasks?.map((task) => (
        <RevTasks key={task.id} task={task} />
      ))}
