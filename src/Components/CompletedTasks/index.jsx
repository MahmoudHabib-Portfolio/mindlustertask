...
const Completed = () => {
  ...
  /* getting tasks count */
  const compTasks = tasks.filter((t) => t.column === "completed");
  const comptaskLength = compTasks.length;
    ...
    <div className={Styles.todoCont}>
      ...
      <div>
        ...
        <div>
         ...
         icon={<GoDotFill style={{color:"#419673", fontSize:"1.6em"}}/>}
         label={<span className={Styles.todo}>done</span>}
         />
        </div>
        {/* Tasks Count */}
